...
class TestOptimization(unittest.TestCase):
    ...
    def test_FANNY_2D_8(self):
        print("test FANNY with 2D data (#data=8)")
    ...
    def test_FANNY_2D_100(self):
        print("test FANNY with 2D data (#data=100)")
